...
Update the version in all three files to the same value (next bump: `0.0.1` → `0.0.2`):
...
```json
{
  ...
  "platforms": {
    "darwin-aarch64": {
      ...
      "url": "https://github.com/anvel-ai/clearly/releases/download/v0.0.2/Clearly.app.tar.gz"
    }
  }
}
```
...
2. Upload these files as release assets:
   ...
   - `Clearly_0.0.2_aarch64.dmg` (for first-time installs)
   - `latest.json`
